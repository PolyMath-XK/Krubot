...
> | Portal | Language |
> |:--|:--|
> | <a href="https://DevGX.ir" target="_blank"><b>DevGX.ir</b></a> | Persian 🇮🇷 |
> | <a href="https://StoryKo.de" target="_blank"><b>StoryKo.de</b></a> | Global 🌍️ |
</div>
...
```
*[See More Examples... 📜✨🔮](#glimpse-into-the-matrix-code-showcase)*
...
## Let the CyberCitadel Ascend to Nexus ⚡🏰🪩💫⚡
...
> *Do you want to Skip the manual configuration rituals ?*

After installing via Composer, invoke the ***Automated Ascension Script*** <br>
...
```bash
# 1. Install KrubiK/Krubot CyberCitadel
composer require krubik/krubot

# 2. Let the Citadel Ascend 🏰💫
...
> ***Faster Onboarding, Cleaner Deployment, Zero-friction Krubot Activation***, all with :: `krubik:ascend`
